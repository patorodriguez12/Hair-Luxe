...
const CreateService = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    price: Yup.number().required("Precio requerido").positive("El precio debe ser positivo"),
  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl">
      <h1 className="text-3xl font-bold mb-6 text-center text-quaternary">Crear Servicio</h1>
      <Formik
